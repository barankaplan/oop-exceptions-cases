...
public final class ExceptionUtil {
    ...
    private static <T extends RuntimeException> void throwException(String msg, Class<T> cls, Throwable ex) {
        try {
            throw cls.getConstructor( Throwable.class,String.class).newInstance( ex,msg);
    ...
    public static <T extends RuntimeException> void doWorkForRunnable(IActionCallback actionCallback,
                                                                      Consumer<Throwable> consumer, String msg, Class<T> cls) {
        try {
            actionCallback.run();
        } catch (Throwable ex) {
            consumer.accept(ex);
